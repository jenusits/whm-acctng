            ...
            <div class="card">
                ...
                @if(sizeof($categories) > 0)
                    <form method="POST" action="/request_funds">
                        ...
                        @if($type != 'bill')
                            <autocomplete name="payee" input-class="form-control" placeholder="Choose Payee" :source="{{ \App\User::all() }}" class="mb-3"></autocomplete>
                            <autocomplete name="account" input-class="form-control" placeholder="Bank/Credit Account" :source="{{ $accounts }}" class="mb-3"></autocomplete>
                        @endif
