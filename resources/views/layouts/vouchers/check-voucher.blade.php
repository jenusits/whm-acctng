...
<div id="print-element" class="container">
    ...
    <div class="mt-5">
        ...
        <div class="row  voucher-details p-5">
            ...
            {{-- <div class="col-md-7">
                <p>Payment To</p>
                <p>{{ \App\Payee::find($expense->getExpenseMeta('payee'))->name }}</p>
            </div>
            <div class="col-md-5">
                <div class="row">
                    <div class="col-md-6"><p>Date:</p></div>
                    <div class="col-md-6"><p>{{ \Carbon\Carbon::parse($expense->getExpenseMeta('payment_date'))->format('m/d/Y') }}</p></div>
                </div>
                <div class="row">
                    <div class="col-md-6"><p>Payment Method:</p></div>
                    <div class="col-md-6"><p>Cheque</p></div>
                </div>
                <div class="row">
                    <div class="col-md-6"><p>Reference No:</p></div>
                    <div class="col-md-6"><p>{{ $expense->id }}</p></div>
                </div>
            </div> --}}
        </div>
